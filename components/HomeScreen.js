  ...
  return (
    <div className="p-4 h-full flex flex-col">
      <div className="text-center py-4">
        <h1 className="text-2xl font-bold text-gray-300">EscadeMobile</h1>
        <p className="text-gray-500 text-sm">Welcome to your phone!</p>
      </div>
      ...
      <div className="flex-1 grid grid-cols-3 gap-4 overflow-y-auto">
        {apps.map((app) => (
          <button
            ...
            className="flex flex-col items-center p-2 rounded-xl hover:bg-gray-200 transition-colors"
          >
            <div className={`${app.color} w-12 h-12 rounded-full flex items-center justify-center mb-1`}>
